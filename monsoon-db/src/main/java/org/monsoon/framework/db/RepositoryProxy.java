...
import org.monsoon.framework.db.helper.CreateRecord;
import org.monsoon.framework.db.helper.CreateTable;
import org.monsoon.framework.db.helper.UpdateRecord;
...
public class RepositoryProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (methodName.equals("createTableIfNotExists")){
            ...
            return CreateRecord.createMany(conn, meta, args[0]);
        } else if (methodName.equals("update")) {
            return UpdateRecord.updateOne(conn, meta, args[0]);
        } else if (methodName.equals("updateMany")) {
            return UpdateRecord.updateMany(conn, meta, args[0]);
        }
